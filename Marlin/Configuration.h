...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 139 } // for micro Swiss direct drive extruder
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45.7, -6, -5.17 } // for micro swiss hotend
// #define NOZZLE_TO_PROBE_OFFSET { -43.65, -10, -0.860 }

// Make sure the bed and travel limits are correct
